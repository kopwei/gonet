...
// name
func SetPeerLinkToDockerNs(linuxLink *LinuxLink, containerID, newName string, ipaddr *net.IPNet) error {
	if containerID == "" {
	...
	return putLinkIntoNetNS(linuxLink, nsHandle, newName, ipaddr)
}
